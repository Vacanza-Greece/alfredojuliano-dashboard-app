            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex space-x-4 pt-4 justify-end">
                <button
                  ...
                  className="border border-blue-600 text-blue-600 font-medium px-4 py-2 rounded-lg hover:bg-blue-50 focus:ring-2 focus:ring-blue-400 focus:outline-none cursor-pointer"
                >
                  Cancel
                </button>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-sm text-center">
            ...
            <div className="flex justify-center space-x-4">
              <button
                ...
                className="border border-gray-400 text-gray-700 font-medium px-4 py-2 rounded-lg hover:bg-gray-100 cursor-pointer"
              >
                Cancel
              </button>
              <button
              ...
              >
                {isDeleting ? "Deleting..." : "Delete Amenities"}
              </button>
            </div>
          </div>
        </div>
