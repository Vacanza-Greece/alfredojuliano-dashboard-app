...
//         variant="ghost"
//         size="sm"
//         className="w-full flex items-center justify-between text-gray-700 border border-gray-300 px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white shadow-sm hover:border-blue-400 transition-all duration-200"
...
//               Cancel
//             </Button>
//             <Button onClick={confirmGiveBadge}>Give Badge</Button>
//           </DialogFooter>
//         </DialogContent>
//       </Dialog>
//     </div>
