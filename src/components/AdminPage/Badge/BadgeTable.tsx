...
// ✅ Enum-like union type for badge types
...
//               <th className="px-4 py-3 text-left">Greek Name</th>
//               <th className="px-4 py-3 text-left">Type</th>
//               <th className="px-4 py-3 text-left">Badge Type</th>
//               <th className="px-4 py-3 text-left">Description</th>
//               <th className="px-4 py-3 text-left">Greek Description</th>
...
//                   value={form.type}
//                   onChange={handleInputChange}
//                   placeholder="e.g. CYCLADES, SARONIC"
//                   className="w-full border px-3 py-2 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
//                   required
//                 />
//               </div>
